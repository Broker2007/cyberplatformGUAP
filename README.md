...
Полнофункциональная версия может в закрытом репозитории; этот открытый срез используется для предпросмотра UI/UX, демонстрации pet-проекта и синхронизации по требованиям. После согласования API и фичи могут подтягиваться из основной кодовой базы.
